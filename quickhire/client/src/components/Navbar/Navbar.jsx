...
export default function Navbar() {
  ...
  return (
    <div className="navbar bg-base-100 sticky top-0 z-50 px-2 xl:px-8">
      <div className="navbar-start">
        <Link to="/" className="btn btn-ghost text-xl lg:text-3xl font-bold gap-0">
      ...
      <div className="navbar-end gap-2">
        <div className="hidden sm:flex lg:gap-4">
          <button className="btn btn-ghost btn-sm md:btn-md text-[#4640DE] font-bold lg:px-4 py-2 hover:text-[#0e0b5c]">
            Login
          </button>
          <button className="btn btn-primary btn-sm font-bold text-white bg-[#4640DE] lg:px-4 py-2 md:btn-md hover:bg-[#0e0b5c]">Sign Up</button>
        </div>
